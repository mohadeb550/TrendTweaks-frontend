  ...
  return (
    <div className="rounded-xl py-12">
      <div className="container mx-auto">
        <h2 className="text-3xl lg:text-4xl font-bold text-center text-gray-600 dark:text-gray-400 mb-10">
          Latest Events
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
          {eventsData.map((event) => (
            <div key={event.id} className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                {/* Event Title */}
                <h3 className="text-2xl font-semibold text-gray-800 dark:text-gray-400 mb-2">
                  {event.title}
                </h3>
