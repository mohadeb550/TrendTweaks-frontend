  ...
  const handleUnfollow = async (targetedId) => {
    ...
    return (
        ...
        <div className="flex flex-col gap-5 mt-3">
          ...
          {/* Following Section */}
         {following?.length?  <div className="lg:hidden bg-white md:bg-gray-100/50 p-6 rounded-lg relative">
        ...
        <ClipLoader
           ...
           speedMultiplier={0.8} />
            ...
            <h2 className="text-lg text-gray-600 font-semibold mb-4">Following ({following?.length})</h2>
           ...
           {/* Followers Section */}
         {followers?.length?  <div className="bg-white md:bg-gray-100/50 p-6 rounded-lg">
            <h2 className="text-lg text-gray-600 font-semibold mb-4">Followers ({followers?.length}) </h2>
            <div className="space-y-4 max-h-28 overflow-y-scroll">
