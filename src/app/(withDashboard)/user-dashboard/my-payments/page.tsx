        ...
        <table
          ...
          <thead className="">
            <tr className="bg-gray-200 dark:bg-gray-800 h-8 text-gray-500 text-[12px] md:text-base ">
              <th
                scope="col"
                className="border-r dark:text-gray-400 px-6 py-0 md:py-2 lg:py-4 border-gray-300 dark:border-gray-700 rounded-l-lg">
               Img
              </th>
              <th
                scope="col"
                className="border-r dark:text-gray-400 px-6 py-0 md:py-2 lg:py-4 border-gray-300 dark:border-gray-700">
              Name
              </th>
              <th
                scope="col"
